...
!function () {
  ...
  var Rt = function Rt() {},
    ...
    begin: function begin(t) {
      return _t.mark("".concat(Tt, " ").concat(t, " begins")), function () {
        return It(t);
      };
    },
    end: It
  ...
  function Jt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Gt[e]) t.prefix = e;else if (J.autoFetchSvg && -1 < ["fas", "far", "fal", "fad", "fab", "fa"].indexOf(e)) t.prefix = e;else if (n) {
  ...
  var ee = {
    replace: function replace(t) {
      ...
      if (e.parentNode && e.outerHTML) e.outerHTML = n + (J.keepOriginalSource && "svg" !== e.tagName.toLowerCase() ? "\x3c!-- ".concat(e.outerHTML, " --\x3e") : "");else if (e.parentNode) {
    ...
    if (l && J.observeMutations) {
      ...
      oe = new l(function (t) {
        re || At(t).forEach(function (t) {
          if ("childList" === t.type && 0 < t.addedNodes.length && !te(t.addedNodes[0]) && (J.searchPseudoElements && o(t.target), r(t.target)), "attributes" === t.type && t.target.parentNode && J.searchPseudoElements && o(t.target.parentNode), "attributes" === t.type && te(t.target) && ~I.indexOf(t.attributeName)) if ("class" === t.attributeName) {
    ...
    return e = t, (n = [{
      ...
      value: function value() {
        ...
        Object.keys(r).forEach(function (t) {
          e.definitions[t] = G({}, e.definitions[t] || {}, r[t]), function t(e, a) {
